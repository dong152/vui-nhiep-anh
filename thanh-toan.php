	...
	<div class="row thanh-toan-row">
		...
		<div class="col-12 col-sm-12 col-lg-6">
			<div class="thanh-toan-ma-anh">
				<p ><b id="thanh-toan-ma-anh">Mã ảnh - TÊN TÁC PHẨM</b></p>
				<p id="thanh-toan-tt-tgia">NHIẾP ẢNH GIA: Trần Minh A</p>
			</div>
		...
		<div class="chu-thich">
			<p id="thanh-toan-chu-thich">Sau khi đã thanh toán và nhấn “Gửi E-mail” chúng tôi sẽ liên hệ
lại cho quý khách qua SĐT để xác nhận thông tin đặt hàng và hình thức vận chuyển.</p>
		</div>
